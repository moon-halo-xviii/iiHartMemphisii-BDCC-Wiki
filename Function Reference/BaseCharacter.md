...
The stat value is clamped between 0 and the value returned by the stat's respective [**threshold function**](#painthreshold-lustthreshold-getmaxstamina-int) (inclusive). It will always emit the *stat_changed* signal.
